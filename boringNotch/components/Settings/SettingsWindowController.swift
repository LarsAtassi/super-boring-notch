...
class SettingsWindowController: NSWindowController {
    ...
    private func setupWindow() {
        ...
        window.title = "Super Boring Notch Settings"
    ...
    func showWindow() {
        // Stay an accessory app unless the user asked for a Dock icon. Switching
        // to .regular is what makes the icon appear in the Dock; an accessory app
        // can still show, focus and type into this window.
    ...
    private func relinquishFocus() {
        ...
        // Always back to accessory, even if a Dock icon was shown.
